...
def main_operateur_window():
    ...
    # def add_global_list_command_user():
    #     global global_list_commande_users
    #     if global_list_commande_users != global_list_commande:
    #         global_list_commande_users.append(global_list_commande)
    #     return global_list_commande_users
    ...
    def add_commandes ():
        global_list_commande_users
        for commande in global_list_commande_users :
